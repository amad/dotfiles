...
# pane border colors
set-window-option -g pane-active-border-style fg=$base0F
...
tm_session_name="#[default,bg=$base00,fg=$base0E] Session: #S #[fg=yellow]#I #[fg=cyan]#P"
...
set -g status-right "$tm_battery $tm_cpu $tm_date $tm_host"
